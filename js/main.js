...
// ABOUT || Glance
ScrollReveal().reveal('.glance-des p', {delay:100, distance:'20px',origin:'right'});
ScrollReveal().reveal('.glance-des p.title', {delay:100, distance:'20px', origin:'bottom'});

// ABOUT|| DES
ScrollReveal().reveal('.about-des-content img', {delay:100, distance:'20px',origin:'top'});
ScrollReveal().reveal('.about-des-isi-content h1, .about-des-isi-content h2, .about-des-isi-content hr', {delay:100, distance:'20px',origin:'bottom'});
ScrollReveal().reveal('.about-des-isi-content p.aa', {delay:100, distance:'20px',origin:'left'});
ScrollReveal().reveal('.about-des-isi-content p.bb', {delay:100, distance:'20px',origin:'right'});

// ABOUT || Value
ScrollReveal().reveal('.our-value', {delay:100, distance:'20px',origin:'bottom'});
ScrollReveal().reveal('.value-des', {delay:100, distance:'20px',origin:'left'});
ScrollReveal().reveal('.value-des hr', {delay:300, distance:'30px',origin:'left'});
ScrollReveal().reveal('.value-des p.des', {delay:200, distance:'20px',origin:'left'});

// ABOUT || Vision
ScrollReveal().reveal('.our-vision', {delay:100, distance:'20px',origin:'bottom'});
ScrollReveal().reveal('.vision-des', {delay:100, distance:'20px',origin:'left'});
ScrollReveal().reveal('.vision-des hr', {delay:300, distance:'30px',origin:'left'});
ScrollReveal().reveal('.vision-des p.des', {delay:200, distance:'20px',origin:'left'});


// ABOUT || Misiion
ScrollReveal().reveal('.mission-title p.des', {delay:100, distance:'20px',origin:'bottom'});
ScrollReveal().reveal('.mission-title .title', {delay:300, distance:'20px',origin:'bottom'});

ScrollReveal().reveal('.mission-cart .no-1', {delay:300, distance:'10px',origin:'bottom'});
ScrollReveal().reveal('.mission-cart .no-2', {delay:300, distance:'10px',origin:'top'});
